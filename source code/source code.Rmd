...
data("ThaiData.csv")
data("A_PCR_Test.csv")
data("A_PCR_Train.csv")
data("M_PCR_Test.csv")
data("M_PCR_Train.csv")
data("TrendLine.csv")
data("Distribution.csv")
data("MultiData.csv")
data("FirstObservation")
data("SecondObervation")
```
...
```
Table 1. The number of auricular surfaces by populations. N number of individuals
...
```{r, warning = FALSE, message = FALSE}
library(corrtable)
Variables<-subset(ThaiData,select=-c(PCQDA_pred,
                                     PCQDA_Mean, PCR_pred, 
                                     PCLR_pred, PCLR_Mean))
...
ggsave("D:/TrendLine_Plots.png", g_all, 
       width = 8, height = 24, dpi = 600, units = "in")
